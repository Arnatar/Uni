...
veraltet(PId,Titel,Lager):-
% Produkt finden, dessen Lager größer als 0 ist.
...
% der erzielt worden wäre mit den Preis aus dem vorherigen Jahr und den Verkaufszahlen des angegebenen Jahres.
